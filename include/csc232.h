...
/** When FINISHED_PART_3 is false, "hello main target appears" */
/** When FINISHED_PART_3 is true, the "Yorkie/GreatDaehn named x was created" message appears along with a randomness seed. The x name is the same in unit_tests*/
...
class Dog 
{
     ...
     * @return A translation of what the Dog says
    */

    virtual std::string speak() const = 0;
   
    /** 
     * @brief Command the Dog to "sit"
     * @return A message is inserted into the standard outpu stream
    */
